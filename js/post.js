...
function sendMsg(e){
    ...
    if (mensajellenar.length != 0) {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: '{"clientId":"1233456","mensaje":"' + mensajellenar + '","plataforma":"web"}',
            success: function(data) {
                ...
                elMsgTemplate.find('.horaenvio').html(hora);
                elMsgTemplate.find('.msgenvio').html(mensajellenar);
...
function Opciones(e) {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: '{"clientId":"1233456","mensaje":"' + e + '","plataforma":"web"}',
        success: function(data) {
